...
DesktopProperties::DesktopProperties(FXApp *app):FXMainWindow(app, "Właściwości: Ekran", ico_mainico, NULL, DECOR_TITLE|DECOR_BORDER|DECOR_CLOSE, 0,0,398,423,  0,0,0,0,  0,0) {
	...
	FXHorizontalFrame* btncont = new FXHorizontalFrame(tabframe, LAYOUT_RIGHT|PACK_UNIFORM_WIDTH, 0, 0, 0, 0, 0, 6, 0, 7, 6, 0);

	new FXButton(btncont, "OK", NULL, this, ID_DLG_OK, BUTTON_DEFAULT|BUTTON_NORMAL, 0,0,0,0, 19,20,2,3);
	new FXButton(btncont, "Anuluj", NULL, this, ID_DLG_CANCEL, BUTTON_NORMAL|BUTTON_DEFAULT, 0,0,0,0, 19,20,2,3);
